...
class MainActivity2 : AppCompatActivity(), MomentzCallback {
            ...
            Picasso.get()
                ...
                .into(view, object : Callback {
                    override fun onSuccess() {
                        momentz.resume()
                        Toast.makeText(this@MainActivity2, "Image loaded from the internet", Toast.LENGTH_LONG).show()
                    }

                    override fun onError(e: Exception?) {
                        Toast.makeText(this@MainActivity2,e?.localizedMessage,Toast.LENGTH_LONG).show()
                        e?.printStackTrace()
                    }
                })
        }
    ...
    override fun done() {
        Toast.makeText(this@MainActivity2, "Finished!", Toast.LENGTH_LONG).show()
    }
        ...
        videoView.setOnInfoListener(object : MediaPlayer.OnInfoListener {
            override fun onInfo(mp: MediaPlayer?, what: Int, extra: Int): Boolean {
                if (what == MediaPlayer.MEDIA_INFO_VIDEO_RENDERING_START) {
                    ...
                    Toast.makeText(this@MainActivity2, "Video loaded from the internet", Toast.LENGTH_LONG).show()
                    return true
                }
                return false
            }
